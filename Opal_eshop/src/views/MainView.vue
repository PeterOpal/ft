    ...
    <section class="container py-5">
        <div class="row text-center pt-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    Each year brings a unique olfactory experience, featuring a carefully chosen collection of perfumes or candles that embody a particular theme or mood. Subscribers eagerly anticipate the unveiling of these aromatic treasures, exploring new fragrances that add a touch of luxury and sophistication to their daily lives.
                </p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="container py-5">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    ...
                    <p>
                        Unlock your fragrance journey with a warm welcome! Enjoy an exclusive welcome discount on your first order.
                    </p>
                    <Countdown deadline="11/7/2023"></Countdown>
                </div>
            </div>
            <div class="row">
                TIMER HERE!!!!!!!!!!!!!!!!!!!!!!!
